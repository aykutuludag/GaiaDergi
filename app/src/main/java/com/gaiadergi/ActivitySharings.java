...
public class ActivitySharings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getFavorites
        mobiledatabase = openOrCreateDatabase("gaiadergi_mobile2", MODE_PRIVATE, null);
        pb.setVisibility(View.INVISIBLE);
        cur = mobiledatabase.rawQuery("Select * from gaiadergi_mobile2", null);
        if (cur.getCount() != 0) {
            cur.moveToFirst();
            do {
        ...
        // Adapter
        mAdapter = new RecyclerViewAdapter(ActivitySharings.this, feedsList);
        mAdapter.notifyDataSetChanged();
        mRecyclerView.setAdapter(mAdapter);

        // The number of Columns
        mLayoutManager = new GridLayoutManager(ActivitySharings.this, 2);
